...
'''
setup(
    name='gpt_2_keyword_generation',
    packages=['gpt_2_keyword_generation'],  # this must be the same as the name above
    version='0.1',
    description="Python package to easily encode data for retraining OpenAI's GPT-2 with relevant keywords",
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Max Woolf',
    author_email='max@minimaxir.com',
    url='https://github.com/minimaxir/gpt-2-keyword-generation',
    keywords=['deep learning', 'tensorflow', 'text generation'],
    classifiers=[],
    license='MIT',
    python_requires='>=3.5',
    include_package_data=True,
    install_requires=['tqdm', 'ray', 'spacy>=2.1.0,<2.2.0', 'en_core_web_sm @ https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-2.1.0/en_core_web_sm-2.1.0.tar.gz']
)